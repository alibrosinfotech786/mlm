      ...
      <div className="max-w-[1400px] mx-5 px-6 md:px-12 ">
        ...
        <div className="flex justify-center gap-4 mb-10">
          <button
            ...
            className={`px-8 py-2 rounded-full text-sm font-semibold transition-all ${activeTab === "upcoming"
          ...
          <button
            ...
            className={`px-8 py-2 rounded-full text-sm font-semibold transition-all ${activeTab === "past"
              ? "bg-green-700 text-white shadow-md"
              : "bg-gray-300 text-gray-700 hover:bg-gray-400"
              }`}
          >
